...
const forecast = (latitude, longitude, callback) => {
    ...
    request({ url, json: true}, (error, {body}) => {  //instead of url: url
        ...
        if(error) {
            ...
            callback(undefined, " It is currently " + body.current.temperature + " degrees out. It feels like " + body.current.feelslike + " though! The humidity is " + body.current.humidity + "%")
